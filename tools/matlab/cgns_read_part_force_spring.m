...
function [Fx, Fy, Fz] = cgns_read_part_force_spring(casename, time)
% CGNS_READ_PART_FORCE_SPRING Read the particle forces from a BLUEBOTTLE-
%   generated CGNS file.
%
%   [Fx, Fy, Fz] = CGNS_READ_PART_FORCE_SPRING(CASENAME, TIME) reads the spring
%   applied particle force from the simulation CASENAME at time TIME. Each of
%   the force components is an array representing all of the particles in the
%   simulation.
%
%   Example:
%     cgns_read_part_force_spring('simulation', 3.14159) will read the
...
fxsol = '/Base/Zone0/Solution/SpringForceX/ data';
fysol = '/Base/Zone0/Solution/SpringForceY/ data';
fzsol = '/Base/Zone0/Solution/SpringForceZ/ data';
